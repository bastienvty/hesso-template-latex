...
%  - l: stretched left aligned
%  - R{}: right aligned, specified space
%  - C{}: centered aligned, specified space
%  - L{}: left aligned, specified space
...
\input{structure/3-tail/ch2_glossary}
\makeglossaries
