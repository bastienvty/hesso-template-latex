...
\setcounter{tocdepth}{2} % Depth to 'subsection'
...
% Make TOC, LOF, LOT titles use sans-serif font to match chapter headings
\renewcommand{\cfttoctitlefont}{\Huge\sffamily\bfseries} % Table of contents
\renewcommand{\cftloftitlefont}{\Huge\sffamily\bfseries} % List of figures
\renewcommand{\cftlottitlefont}{\Huge\sffamily\bfseries} % List of tables
\renewcommand{\cftloltitlefont}{\Huge\sffamily\bfseries} % List of listings

\renewcommand{\cftchapfont}{\sffamily\bfseries} % Chapter titles
\renewcommand{\cftchappagefont}{\sffamily\bfseries} % Chapter page numbers
\renewcommand{\cftsecfont}{\sffamily} % Section titles
\renewcommand{\cftsecpagefont}{\sffamily} % Section page numbers
\renewcommand{\cftsubsecfont}{\sffamily} % Subsection titles
\renewcommand{\cftsubsecpagefont}{\sffamily} % Subsection page numbers
...
\titlespacing{\chapter}{-5mm}{-10mm}{15mm}
\titlespacing{\section}{-3mm}{4mm}{2mm}
\titlespacing{\subsection}{-3mm}{2mm}{2mm}
\titlespacing{\subsubsection}{-2mm}{2mm}{0mm}

\titleformat{\chapter}
{\Huge\sffamily\bfseries}
{\llap{\thechapter\hspace{12pt}\textcolor{gray80}{|}}}
{0mm}
...
% Chapters on same page - no longer needed with \input
% \usepackage{etoolbox}
% \makeatletter
